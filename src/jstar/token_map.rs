...
pub enum TokenCategory {
    ...
    BlockEnd,
    /// Inline raw assembly statement: `inline "..."`
    InlineAssembly,
    /// Physical register marker: the next token names the register.
    PhysicalRegister,
...
static KEYWORD_TABLE: LazyLock<HashMap<i32, TokenCategory>> = LazyLock::new(|| {
    let entries: &[(&str, TokenCategory)] = &[
        ...
        (
            "compare",
            TokenCategory::Operation(JStarInstruction::Compare),
        ),
        ...
        (
            "greater",
            TokenCategory::Operation(JStarInstruction::Greater),
        ),
        ...
        (
            "syscall",
            TokenCategory::Operation(JStarInstruction::Syscall),
        ),
        ...
        (
            "allocate",
            TokenCategory::Operation(JStarInstruction::Allocate),
        ),
        (
            "addressof",
            TokenCategory::Operation(JStarInstruction::AddressOf),
        ),
        ...
        // ── Inline assembly ──
        ("inline", TokenCategory::InlineAssembly),
        // ── Physical register marker ──
        ("register", TokenCategory::PhysicalRegister),
